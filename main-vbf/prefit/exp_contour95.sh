...
combine -M MultiDimFit -m 125 output/testModel${year}/model_combined.root --algo contour2d --points=100 --cl=0.95 --cminDefaultMinimizerStrategy 0 --robustFit=1 -t -1 --redefineSignalPOIs rVBF,rggF --setParameters rggF=1,rVBF=1
