...
combine -M FitDiagnostics -m 125 output/testModel${year}/model_combined.root --setParameters rVBF=1,rggF=1 -t -1 --saveShapes --saveWithUncertainties --robustFit=1 --robustHesse=1 --verbose 9
