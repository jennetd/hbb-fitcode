...
combine -M MultiDimFit -m 125 output/testModel${year}/model_combined.root --algo grid --points=2500 --robustFit=1 -t -1 --redefineSignalPOIs rVBF,rggF --setParameters rVBF=1,rggF=1
