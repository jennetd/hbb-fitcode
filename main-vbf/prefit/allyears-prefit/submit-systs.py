...
def main():
    ...
    frozen["TFres"]="rgx{CMS_.*},rgx{QCDscale_.*},rgx{UEPS_.*},rgx{pdf_.*},rgx{.*mcstat},rgx{qcd.*},rgx{ttq.*},rgx{tf_MC.*}"
    frozen["TTQ"]="rgx{CMS_.*},rgx{QCDscale_.*},rgx{UEPS_.*},rgx{pdf_.*},rgx{tf.*},rgx{qcd.*},rgx{.*mcstat}"
