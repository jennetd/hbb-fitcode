...
--PO 'map=ptbin0mjjbin0vbf.*/ggF:rggF7[1,-4,5]' --PO 'map=ptbin0mjjbin1vbf.*/ggF:rggF8[1,-4,5]' \
--PO 'map=ptbin0mjjbin0ggf.*/VBF:rVBF1[1,-4,5]' --PO 'map=ptbin1mjjbin0ggf.*/VBF:rVBF2[1,-4,5]' \
--PO 'map=ptbin2mjjbin0ggf.*/VBF:rVBF3[1,-4,5]' --PO 'map=ptbin3mjjbin0ggf.*/VBF:rVBF4[1,-4,5]' \
--PO 'map=ptbin4mjjbin0ggf.*/VBF:rVBF5[1,-4,5]' --PO 'map=ptbin5mjjbin0ggf.*/VBF:rVBF6[1,-4,5]' \
